...
return [
    ...
    [ // $regexpList
        0 => '{^(?'
                ...
                .'|/a(?'
                    ...
                    .')'
                .')'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/account/order/([^/]++)/subscription\\-mollie/cancel(*:7646)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/order/([^/]++)/subscription\\-mollie/cancel(*:7774)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/payment\\-fee\\-calculate/([^/]++)/([^/]++)(*:7901)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/no\\-payment\\-fee\\-calculate(*:8014)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/mollie/apple\\-direct/validation(*:8131)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/apple\\-pay\\-payment(*:8236)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/mollie/apple\\-direct/complete(*:8351)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/create\\-payment(*:8452)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/get\\-code(*:8547)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/remove\\-code(*:8645)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/complete\\-payment(*:8748)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/update\\-payment(*:8849)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/thank\\-you(*:8945)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/fetch\\-translations(*:9050)'
                .'|/admin/(?'
                    .'|download/payouts\\-report/([^/]++)(*:9102)'
                    .'|enable\\-seller/([^/]++)(*:9134)'
                .')'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/pay\\-with\\-paypal/([^/]++)/([^/]++)(*:9256)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/create\\-pay\\-pal\\-order/([^/]++)(*:9374)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/create\\-pay\\-pal\\-order\\-from\\-cart/([^/]++)(*:9504)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/complete\\-pay\\-pal\\-order/([^/]++)(*:9624)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/process\\-pay\\-pal\\-order(*:9734)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/update\\-pay\\-pal\\-order(*:9843)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/pay\\-pal\\-order\\-payment\\-page/([^/]++)/create(*:9975)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/pay\\-pal\\-order\\-payment\\-page/([^/]++)/complete(*:10109)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/cancel\\-pay\\-pal\\-order(*:10219)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/cancel\\-pay\\-pal\\-payment(*:10331)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/order/([^/]++)/cancel\\-last\\-pay\\-pal\\-payment(*:10464)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/cancel\\-pay\\-pal\\-checkout\\-payment(*:10586)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/pay\\-pal\\-payment\\-error(*:10697)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/paypal\\-add\\-to\\-cart/([^/]++)(*:10814)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)(*:10900)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/_components/([^/]++)(?:/([^/]++))?(*:11021)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/login(*:11113)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/login\\-check(*:11212)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/json\\-login\\-check(*:11317)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/logout(*:11410)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/register(*:11505)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/register\\-after\\-checkout/([^/]++)(*:11626)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/register/thank\\-you(*:11732)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/forgotten\\-password(*:11838)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/forgotten\\-password/([^/]++)(*:11953)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/verify(*:12046)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/verify/([^/]++)(*:12148)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/products/([^/]++)(*:12252)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/taxons/(.+(?<!/))(*:12356)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/products/([^/]++)/reviews(*:12468)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/products/([^/]++)/reviews/new(*:12584)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/cart(*:12675)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/cart/checkout(*:12775)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/checkout(*:12870)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/checkout/address(*:12973)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/checkout/select\\-shipping(*:13085)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/checkout/select\\-payment(*:13196)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/checkout/complete(*:13300)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/contact(*:13394)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/order/thank\\-you(*:13497)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/order/([^/]++)/pay(*:13602)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/order/after\\-pay(?:/([^/]++))?(*:13719)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/order/([^/]++)(*:13820)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/payment\\-request/pay/([^/]++)(*:13936)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/account/_components/([^/]++)(?:/([^/]++))?(*:14065)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/account/orders(*:14166)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/account/orders/([^/]++)(*:14276)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/account/address\\-book(*:14384)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/account/address\\-book/add(*:14496)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/account/address\\-book/([^/]++)/edit(*:14618)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/account/address\\-book/([^/]++)(*:14735)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/account/address\\-book/([^/]++)/set\\-as\\-default(*:14869)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/account(*:14963)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/account/dashboard(*:15067)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/account/profile/edit(*:15174)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/account/change\\-password(*:15285)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/switch\\-currency/([^/]++)(*:15397)'
                .'|/([A-Za-z]{2,4}(?:_(?:[A-Za-z]{4}|[0-9]{3}))?(?:_(?:[A-Za-z]{2}|[0-9]{3}))?)/switch\\-locale/([^/]++)(*:15507)'
                .'|/payment(?'
                    .'|/(?'
                        .'|authorize/([^/]++)(*:15550)'
                        .'|capture/([^/]++)(*:15576)'
    ...
    [ // $dynamicRoutes
        ...
        7646 => [[['_route' => 'sylius_mollie_shop_cancel_subscription_mollie', '_controller' => 'sylius_mollie.controller.admin.mollie_subscription::applyStateMachineTransitionAction', '_sylius' => ['repository' => ['method' => 'findOneByOrderIdAsString', 'arguments' => ['$orderId']], 'state_machine' => ['graph' => 'mollie_subscription_payment_graph_manual', 'transition' => 'cancel'], 'redirect' => 'referer', 'flash' => 'sylius_mollie.subscription.cancelled']], ['_locale', 'orderId'], ['PUT' => 0], null, false, false, null]],
        7774 => [[['_route' => 'sylius_mollie_shop_cancel_order_subscription', '_controller' => 'sylius_mollie.controller.admin.mollie_subscription::applyStateMachineTransitionAction', '_sylius' => ['repository' => ['method' => 'findOneActiveByOrderToken', 'arguments' => ['$orderToken']], 'state_machine' => ['graph' => 'mollie_subscription_payment_graph_manual', 'transition' => 'cancel'], 'redirect' => 'referer', 'flash' => 'sylius_mollie.subscription.cancelled']], ['_locale', 'orderToken'], ['PUT' => 0], null, false, false, null]],
        7901 => [[['_route' => 'sylius_mollie_shop_payment_fee_calculate', '_controller' => 'sylius_mollie.controller.shop.payment_fee_calculate'], ['_locale', 'gatewayName', 'methodId'], null, null, false, true, null]],
        8014 => [[['_route' => 'sylius_mollie_shop_no_payment_fee_calculate', '_controller' => 'sylius_mollie.controller.shop.no_payment_fee_calculate'], ['_locale'], null, null, false, false, null]],
        8131 => [[['_route' => 'sylius_mollie_shop_apple_pay_validation', '_controller' => 'sylius_mollie.controller.shop.apple_pay_validation'], ['_locale'], ['POST' => 0], null, false, false, null]],
        8236 => [[['_route' => 'sylius_mollie_shop_apple_pay_payment', '_controller' => 'sylius_mollie_plugin.controller.action.shop.apple_pay_create_payment'], ['_locale'], ['POST' => 0], null, false, false, null]],
        8351 => [[['_route' => 'sylius_mollie_shop_checkout_apple_complete', '_controller' => 'sylius_mollie.controller.shop.order::updateAppleOrderAction', '_sylius' => ['event' => 'complete', 'flash' => false, 'repository' => ['method' => 'findCartForSummary', 'arguments' => ['expr:service(\'sylius.context.cart\').getCart().getId()']], 'state_machine' => ['graph' => 'sylius_order_checkout', 'transition' => 'complete']]], ['_locale'], ['POST' => 0, 'GET' => 1], null, false, false, null]],
        8452 => [[['_route' => 'sylius_mollie_shop_qr_code', '_controller' => 'sylius_mollie.controller.shop.qr_code::createPayment'], ['_locale'], null, null, false, false, null]],
        8547 => [[['_route' => 'sylius_mollie_shop_get_qr_code', '_controller' => 'sylius_mollie.controller.shop.qr_code::fetchQrCodeFromOrder'], ['_locale'], null, null, false, false, null]],
        8645 => [[['_route' => 'sylius_mollie_shop_remove_qr_code', '_controller' => 'sylius_mollie.controller.shop.qr_code::removeQrCodeFromOrder'], ['_locale'], null, null, false, false, null]],
        8748 => [[['_route' => 'sylius_mollie_shop_payum', '_controller' => 'sylius_mollie.controller.shop.payum'], ['_locale'], null, null, false, false, null]],
        8849 => [[['_route' => 'sylius_mollie_shop_payment_webhook', '_controller' => 'sylius_mollie.controller.shop.payment_webhook'], ['_locale'], null, null, false, false, null]],
        8945 => [[['_route' => 'sylius_mollie_shop_thank_you_page_redirect', '_controller' => 'sylius_mollie.controller.shop.page_redirect::thankYouAction'], ['_locale'], null, null, false, false, null]],
        9050 => [[['_route' => 'sylius_mollie_shop_credit_card_translation', '_controller' => 'sylius_mollie.controller.shop.credit_card_translation::fetchTranslations'], ['_locale'], null, null, false, false, null]],
        9102 => [[['_route' => 'sylius_paypal_admin_download_payouts_report', '_controller' => 'sylius_paypal.controller.download_payouts_report'], ['id'], ['GET' => 0], null, false, true, null]],
        9134 => [[['_route' => 'sylius_paypal_admin_enable_seller', '_controller' => 'sylius_paypal.controller.enable_seller'], ['id'], ['POST' => 0], null, false, true, null]],
        9256 => [[['_route' => 'sylius_paypal_shop_pay_with_paypal_form', '_controller' => 'sylius_paypal.controller.pay_with_paypal_form'], ['_locale', 'orderToken', 'paymentId'], ['GET' => 0], null, false, true, null]],
        9374 => [[['_route' => 'sylius_paypal_shop_create_paypal_order', '_controller' => 'sylius_paypal.controller.create_paypal_order'], ['_locale', 'token'], ['POST' => 0], null, false, true, null]],
        9504 => [[['_route' => 'sylius_paypal_shop_create_paypal_order_from_cart', '_controller' => 'sylius_paypal.controller.create_paypal_order_from_cart'], ['_locale', 'id'], ['POST' => 0, 'GET' => 1], null, false, true, null]],
        9624 => [[['_route' => 'sylius_paypal_shop_complete_paypal_order', '_controller' => 'sylius_paypal.controller.complete_paypal_order'], ['_locale', 'token'], ['POST' => 0], null, false, true, null]],
        9734 => [[['_route' => 'sylius_paypal_shop_process_paypal_order', '_controller' => 'sylius_paypal.controller.process_paypal_order'], ['_locale'], ['POST' => 0], null, true, false, null]],
        9843 => [[['_route' => 'sylius_paypal_shop_update_paypal_order', '_controller' => 'sylius_paypal.controller.update_paypal_order'], ['_locale'], ['POST' => 0], null, false, false, null]],
        9975 => [[['_route' => 'sylius_paypal_shop_create_paypal_order_from_payment_page', '_controller' => 'sylius_paypal.controller.create_paypal_order_from_payment_page'], ['_locale', 'id'], ['POST' => 0], null, false, false, null]],
        10109 => [[['_route' => 'sylius_paypal_shop_complete_paypal_order_from_payment_page', '_controller' => 'sylius_paypal.controller.complete_paypal_order_from_payment_page'], ['_locale', 'id'], ['POST' => 0], null, false, false, null]],
        10219 => [[['_route' => 'sylius_paypal_shop_cancel_order', '_controller' => 'sylius_paypal.controller.cancel_paypal_order'], ['_locale'], ['POST' => 0], null, false, false, null]],
        10331 => [[['_route' => 'sylius_paypal_shop_cancel_payment', '_controller' => 'sylius_paypal.controller.cancel_paypal_payment'], ['_locale'], ['POST' => 0], null, false, false, null]],
        10464 => [[['_route' => 'sylius_paypal_shop_cancel_last_payment', '_controller' => 'sylius_paypal.controller.cancel_last_paypal_payment'], ['_locale', 'token'], ['GET' => 0], null, false, false, null]],
        10586 => [[['_route' => 'sylius_paypal_shop_cancel_checkout_payment', '_controller' => 'sylius_paypal.controller.cancel_paypal_checkout_payment'], ['_locale'], ['POST' => 0], null, false, false, null]],
        10697 => [[['_route' => 'sylius_paypal_shop_payment_error', '_controller' => 'sylius_paypal.controller.paypal_payment_on_error'], ['_locale'], ['POST' => 0], null, false, false, null]],
        10814 => [[['_route' => 'sylius_paypal_shop_add_to_cart', '_controller' => 'sylius_paypal.controller.add_to_cart', '_sylius' => ['factory' => ['method' => 'createForProduct', 'arguments' => ['expr:notFoundOnNull(service(\'sylius.repository.product\').find($productId))']], 'form' => ['type' => 'Sylius\\Bundle\\CoreBundle\\Form\\Type\\Order\\AddToCartType', 'options' => ['product' => 'expr:notFoundOnNull(service(\'sylius.repository.product\').find($productId))']]]], ['_locale', 'productId'], ['POST' => 0], null, false, true, null]],
        10900 => [[['_route' => 'sylius_shop_homepage', 'template' => '@SyliusShop/homepage/index.html.twig', '_controller' => 'Symfony\\Bundle\\FrameworkBundle\\Controller\\TemplateController::templateAction'], ['_locale'], ['GET' => 0], null, true, true, null]],
        11021 => [[['_route' => 'sylius_shop_live_component', '_live_action' => 'get'], ['_locale', '_live_component', '_live_action'], null, null, false, true, null]],
        11113 => [[['_route' => 'sylius_shop_login', '_controller' => 'sylius.controller.security::loginAction', '_sylius' => ['template' => '@SyliusShop/account/login.html.twig', 'logged_in_route' => 'sylius_shop_account_dashboard']], ['_locale'], ['GET' => 0], null, false, false, null]],
        11212 => [[['_route' => 'sylius_shop_login_check', '_controller' => 'sylius.controller.security::checkAction'], ['_locale'], ['POST' => 0], null, false, false, null]],
        11317 => [[['_route' => 'sylius_shop_json_login_check', '_controller' => 'sylius.controller.security::jsonLoginCheck'], ['_locale'], ['POST' => 0], null, false, false, null]],
        11410 => [[['_route' => 'sylius_shop_logout'], ['_locale'], ['GET' => 0], null, false, false, null]],
        11505 => [[['_route' => 'sylius_shop_register', '_controller' => 'sylius.controller.customer::createAction', '_sylius' => ['template' => '@SyliusShop/account/register.html.twig', 'form' => 'Sylius\\Bundle\\ShopBundle\\Form\\Type\\CustomerRegistrationType', 'event' => 'register', 'redirect' => ['route' => 'sylius_shop_register_thank_you'], 'flash' => 'sylius.customer.register']], ['_locale'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        11626 => [[['_route' => 'sylius_shop_register_after_checkout', '_controller' => 'sylius.controller.customer::createAction', '_sylius' => ['form' => 'Sylius\\Bundle\\ShopBundle\\Form\\Type\\CustomerRegistrationType', 'factory' => ['method' => ['expr:service("sylius.factory.customer_after_checkout")', 'createAfterCheckout'], 'arguments' => ['expr:service("sylius.repository.order").findOneByTokenValue($tokenValue)']], 'template' => '@SyliusShop/account/register.html.twig', 'event' => 'register', 'redirect' => ['route' => 'sylius_shop_register_thank_you'], 'flash' => 'sylius.customer.register']], ['_locale', 'tokenValue'], ['GET' => 0], null, false, true, null]],
        11732 => [[['_route' => 'sylius_shop_register_thank_you', '_controller' => 'sylius_shop.controller.register_thank_you::thankYouAction'], ['_locale'], ['GET' => 0], null, false, false, null]],
        11838 => [[['_route' => 'sylius_shop_request_password_reset_token', '_controller' => 'sylius.controller.shop_user::requestPasswordResetTokenAction', '_sylius' => ['template' => '@SyliusShop/account/forgotten_password.html.twig', 'redirect' => 'sylius_shop_login']], ['_locale'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        11953 => [[['_route' => 'sylius_shop_password_reset', '_controller' => 'sylius.controller.shop_user::resetPasswordAction', '_sylius' => ['template' => '@SyliusShop/account/reset_password.html.twig', 'redirect' => 'sylius_shop_login']], ['_locale', 'token'], ['GET' => 0, 'POST' => 1], null, false, true, null]],
        12046 => [[['_route' => 'sylius_shop_user_request_verification_token', '_controller' => 'sylius.controller.shop_user::requestVerificationTokenAction', '_sylius' => ['redirect' => 'sylius_shop_account_dashboard']], ['_locale'], ['POST' => 0], null, false, false, null]],
        12148 => [[['_route' => 'sylius_shop_user_verification', '_controller' => 'sylius.controller.shop_user::verifyAction', '_sylius' => ['redirect' => 'sylius_shop_account_dashboard']], ['_locale', 'token'], ['GET' => 0], null, false, true, null]],
        12252 => [[['_route' => 'sylius_shop_product_show', '_controller' => 'sylius.controller.product::showAction', '_sylius' => ['template' => '@SyliusShop/product/show.html.twig', 'repository' => ['method' => 'findOneByChannelAndSlug', 'arguments' => ['expr:service(\'sylius.context.channel\').getChannel()', 'expr:service(\'sylius.context.locale\').getLocaleCode()', '$slug']]]], ['_locale', 'slug'], ['GET' => 0], null, false, true, null]],
        12356 => [[['_route' => 'sylius_shop_product_index', '_controller' => 'sylius.controller.product::indexAction', '_sylius' => ['template' => '@SyliusShop/product/index.html.twig', 'grid' => 'sylius_shop_product']], ['_locale', 'slug'], ['GET' => 0], null, false, true, null]],
        12468 => [[['_route' => 'sylius_shop_product_review_index', '_controller' => 'sylius.controller.product_review::indexAction', '_sylius' => ['template' => '@SyliusShop/product_review/index.html.twig', 'repository' => ['method' => 'findAcceptedByProductSlugAndChannel', 'arguments' => ['$slug', 'expr:service(\'sylius.context.locale\').getLocaleCode()', 'expr:service(\'sylius.context.channel\').getChannel()']]]], ['_locale', 'slug'], ['GET' => 0], null, true, false, null]],
        12584 => [[['_route' => 'sylius_shop_product_review_create', '_controller' => 'sylius.controller.product_review::createAction', '_sylius' => ['template' => '@SyliusShop/product_review/create.html.twig', 'form' => ['type' => 'Sylius\\Bundle\\ShopBundle\\Form\\Type\\Product\\ProductReviewType', 'options' => ['validation_groups' => ['sylius', 'sylius_review']]], 'factory' => ['method' => 'createForSubjectWithReviewer', 'arguments' => ['expr:notFoundOnNull(service(\'sylius.repository.product\').findOneByChannelAndSlug(service(\'sylius.context.channel\').getChannel(), service(\'sylius.context.locale\').getLocaleCode(), $slug))', 'expr:service(\'sylius.context.customer\').getCustomer()']], 'redirect' => ['route' => 'sylius_shop_product_show', 'parameters' => ['slug' => '$slug']], 'flash' => 'sylius.review.wait_for_the_acceptation']], ['_locale', 'slug'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        12675 => [[['_route' => 'sylius_shop_cart_summary', '_controller' => 'sylius.controller.order::summaryAction', '_sylius' => ['template' => '@SyliusShop/cart/index.html.twig', 'form' => 'Sylius\\Bundle\\ShopBundle\\Form\\Type\\CartType']], ['_locale'], ['GET' => 0], null, true, false, null]],
        12775 => [[['_route' => 'sylius_shop_cart_checkout', '_controller' => 'sylius.controller.order::saveAction', '_sylius' => ['template' => '@SyliusShop/cart/index.html.twig', 'redirect' => 'sylius_shop_checkout_start', 'form' => 'Sylius\\Bundle\\ShopBundle\\Form\\Type\\CartType', 'flash' => false]], ['_locale'], ['PATCH' => 0], null, false, false, null]],
        12870 => [[['_route' => 'sylius_shop_checkout_start', '_controller' => 'Symfony\\Bundle\\FrameworkBundle\\Controller\\RedirectController::redirectAction', 'route' => 'sylius_shop_checkout_address'], ['_locale'], ['GET' => 0], null, true, false, null]],
        12973 => [[['_route' => 'sylius_shop_checkout_address', '_controller' => 'sylius.controller.order::updateAction', '_sylius' => ['event' => 'address', 'flash' => false, 'template' => '@SyliusShop/checkout/address.html.twig', 'form' => ['type' => 'Sylius\\Bundle\\ShopBundle\\Form\\Type\\Checkout\\AddressType', 'options' => ['customer' => 'expr:service(\'sylius.context.customer\').getCustomer()']], 'repository' => ['method' => 'findCartForAddressing', 'arguments' => ['expr:service(\'sylius.context.cart\').getCart().getId()']], 'state_machine' => ['graph' => 'sylius_order_checkout', 'transition' => 'address']]], ['_locale'], ['GET' => 0, 'PUT' => 1], null, false, false, null]],
        13085 => [[['_route' => 'sylius_shop_checkout_select_shipping', '_controller' => 'sylius.controller.order::updateAction', '_sylius' => ['event' => 'select_shipping', 'flash' => false, 'template' => '@SyliusShop/checkout/select_shipping.html.twig', 'form' => 'Sylius\\Bundle\\ShopBundle\\Form\\Type\\Checkout\\SelectShippingType', 'repository' => ['method' => 'findCartForSelectingShipping', 'arguments' => ['expr:service(\'sylius.context.cart\').getCart().getId()']], 'state_machine' => ['graph' => 'sylius_order_checkout', 'transition' => 'select_shipping']]], ['_locale'], ['GET' => 0, 'PUT' => 1], null, false, false, null]],
        13196 => [[['_route' => 'sylius_shop_checkout_select_payment', '_controller' => 'sylius.controller.order::updateAction', '_sylius' => ['event' => 'payment', 'flash' => false, 'template' => '@SyliusShop/checkout/select_payment.html.twig', 'form' => 'Sylius\\Bundle\\ShopBundle\\Form\\Type\\Checkout\\SelectPaymentType', 'repository' => ['method' => 'findCartForSelectingPayment', 'arguments' => ['expr:service(\'sylius.context.cart\').getCart().getId()']], 'state_machine' => ['graph' => 'sylius_order_checkout', 'transition' => 'select_payment']]], ['_locale'], ['GET' => 0, 'PUT' => 1], null, false, false, null]],
        13300 => [[['_route' => 'sylius_shop_checkout_complete', '_controller' => 'sylius.controller.order::updateAction', '_sylius' => ['event' => 'complete', 'flash' => false, 'template' => '@SyliusShop/checkout/complete.html.twig', 'repository' => ['method' => 'findCartForSummary', 'arguments' => ['expr:service(\'sylius.context.cart\').getCart().getId()']], 'state_machine' => ['graph' => 'sylius_order_checkout', 'transition' => 'complete'], 'redirect' => ['route' => 'sylius_shop_order_pay', 'parameters' => ['tokenValue' => 'resource.tokenValue']], 'form' => ['type' => 'Sylius\\Bundle\\CoreBundle\\Form\\Type\\Checkout\\CompleteType', 'options' => ['validation_groups' => 'sylius_checkout_complete']]]], ['_locale'], ['GET' => 0, 'PUT' => 1], null, false, false, null]],
        13394 => [[['_route' => 'sylius_shop_contact_request', '_controller' => 'sylius_shop.controller.contact::requestAction', '_sylius' => ['redirect' => 'sylius_shop_homepage']], ['_locale'], ['GET' => 0, 'POST' => 1], null, true, false, null]],
        13497 => [[['_route' => 'sylius_shop_order_thank_you', '_controller' => 'sylius.controller.order::thankYouAction', '_sylius' => ['template' => '@SyliusShop/order/thank_you.html.twig']], ['_locale'], ['GET' => 0], null, false, false, null]],
        13602 => [[['_route' => 'sylius_shop_order_pay', '_controller' => 'sylius_shop.controller.order_pay::payAction', '_sylius' => ['redirect' => ['route' => 'sylius_shop_order_after_pay']]], ['_locale', 'tokenValue'], ['GET' => 0], null, false, false, null]],
        13719 => [[['_route' => 'sylius_shop_order_after_pay', 'hash' => null, '_controller' => 'sylius_shop.controller.order_pay::afterPayAction'], ['_locale', 'hash'], ['GET' => 0, 'POST' => 1], null, false, true, null]],
        13820 => [[['_route' => 'sylius_shop_order_show', '_controller' => 'sylius.controller.order::updateAction', '_sylius' => ['template' => '@SyliusShop/order/show.html.twig', 'repository' => ['method' => 'findOneBy', 'arguments' => [['tokenValue' => '$tokenValue']]], 'form' => ['type' => 'Sylius\\Bundle\\CoreBundle\\Form\\Type\\Checkout\\SelectPaymentType', 'options' => ['validation_groups' => ['sylius_order_pay']]], 'redirect' => ['route' => 'sylius_shop_order_pay', 'parameters' => ['tokenValue' => 'resource.tokenValue']], 'flash' => false]], ['_locale', 'tokenValue'], ['GET' => 0, 'PUT' => 1], null, false, true, null]],
        13936 => [[['_route' => 'sylius_shop_payment_request_pay', '_controller' => 'sylius_shop.controller.payment_request_pay'], ['_locale', 'hash'], null, null, false, true, null]],
        14065 => [[['_route' => 'sylius_shop_account_live_component', '_live_action' => 'get'], ['_locale', '_live_component', '_live_action'], null, null, false, true, null]],
        14166 => [[['_route' => 'sylius_shop_account_order_index', '_controller' => 'sylius.controller.order::indexAction', '_sylius' => ['section' => 'shop_account', 'template' => '@SyliusShop/account/order/index.html.twig', 'grid' => 'sylius_shop_account_order']], ['_locale'], ['GET' => 0], null, true, false, null]],
        14276 => [[['_route' => 'sylius_shop_account_order_show', '_controller' => 'sylius.controller.order::showAction', '_sylius' => ['section' => 'shop_account', 'template' => '@SyliusShop/account/order/show.html.twig', 'repository' => ['method' => 'findOneByNumberAndCustomer', 'arguments' => ['$number', 'expr:service(\'sylius.context.customer\').getCustomer()']]]], ['_locale', 'number'], ['GET' => 0], null, false, true, null]],
        14384 => [[['_route' => 'sylius_shop_account_address_book_index', '_controller' => 'sylius.controller.address::indexAction', '_sylius' => ['section' => 'shop_account', 'template' => '@SyliusShop/account/address_book/index.html.twig', 'paginate' => false, 'repository' => ['method' => 'findByCustomer', 'arguments' => ['expr:service(\'sylius.context.customer\').getCustomer()']]]], ['_locale'], ['GET' => 0], null, true, false, null]],
        ...
        14618 => [[['_route' => 'sylius_shop_account_address_book_update', '_controller' => 'sylius.controller.address::updateAction', '_sylius' => ['form' => ['type' => 'Sylius\\Bundle\\ShopBundle\\Form\\Type\\AddressType'], 'section' => 'shop_account', 'template' => '@SyliusShop/account/address_book/update.html.twig', 'repository' => ['method' => 'findOneByCustomer', 'arguments' => ['$id', 'expr:service(\'sylius.context.customer\').getCustomer()']], 'redirect' => ['route' => 'sylius_shop_account_address_book_index', 'parameters' => []]]], ['_locale', 'id'], ['GET' => 0, 'PUT' => 1], null, false, false, null]],
        14735 => [[['_route' => 'sylius_shop_account_address_book_delete', '_controller' => 'sylius.controller.address::deleteAction', '_sylius' => ['section' => 'shop_account', 'repository' => ['method' => 'findOneByCustomer', 'arguments' => ['$id', 'expr:service(\'sylius.context.customer\').getCustomer()']], 'redirect' => 'sylius_shop_account_address_book_index']], ['_locale', 'id'], ['DELETE' => 0], null, false, true, null]],
        14869 => [[['_route' => 'sylius_shop_account_address_book_set_as_default', '_controller' => 'sylius.controller.customer::updateAction', '_sylius' => ['section' => 'shop_account', 'form' => ['type' => 'Sylius\\Bundle\\ShopBundle\\Form\\Type\\CustomerDefaultAddressType', 'options' => ['customer' => 'expr:service(\'sylius.context.customer\').getCustomer()']], 'repository' => ['method' => 'find', 'arguments' => ['expr:service(\'sylius.context.customer\').getCustomer()']], 'redirect' => ['route' => 'sylius_shop_account_address_book_index', 'parameters' => []], 'flash' => 'sylius.customer.set_address_as_default']], ['_locale', 'id'], ['GET' => 0, 'PATCH' => 1], null, false, false, null]],
        14963 => [[['_route' => 'sylius_shop_account_root', '_controller' => 'Symfony\\Bundle\\FrameworkBundle\\Controller\\RedirectController::redirectAction', 'route' => 'sylius_shop_account_dashboard', 'permanent' => true], ['_locale'], ['GET' => 0], null, true, false, null]],
        15067 => [[['_route' => 'sylius_shop_account_dashboard', '_controller' => 'sylius.controller.customer::showAction', '_sylius' => ['template' => '@SyliusShop/account/dashboard.html.twig', 'repository' => ['method' => 'find', 'arguments' => ['expr:service(\'sylius.context.customer\').getCustomer()']]]], ['_locale'], ['GET' => 0], null, false, false, null]],
        15174 => [[['_route' => 'sylius_shop_account_profile_update', '_controller' => 'sylius.controller.customer::updateAction', '_sylius' => ['template' => '@SyliusShop/account/profile_update.html.twig', 'form' => 'Sylius\\Bundle\\ShopBundle\\Form\\Type\\CustomerProfileType', 'repository' => ['method' => 'find', 'arguments' => ['expr:service(\'sylius.context.customer\').getCustomer()']], 'redirect' => ['route' => 'sylius_shop_account_profile_update', 'parameters' => []]]], ['_locale'], ['GET' => 0, 'PUT' => 1], null, false, false, null]],
        15285 => [[['_route' => 'sylius_shop_account_change_password', '_controller' => 'sylius.controller.shop_user::changePasswordAction', '_sylius' => ['form' => 'Sylius\\Bundle\\ShopBundle\\Form\\Type\\UserChangePasswordType', 'template' => '@SyliusShop/account/change_password.html.twig', 'redirect' => 'sylius_shop_account_dashboard']], ['_locale'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        15397 => [[['_route' => 'sylius_shop_switch_currency', '_controller' => 'sylius_shop.controller.currency_switch::switchAction'], ['_locale', 'code'], ['GET' => 0], null, false, true, null]],
        15507 => [[['_route' => 'sylius_shop_switch_locale', '_controller' => 'sylius_shop.controller.locale_switch::switchAction'], ['_locale', 'code'], ['GET' => 0], null, false, true, null]],
        15550 => [[['_route' => 'payum_authorize_do', '_controller' => 'Payum\\Bundle\\PayumBundle\\Controller\\AuthorizeController::doAction'], ['payum_token'], null, null, false, true, null]],
        15576 => [[['_route' => 'payum_capture_do', '_controller' => 'Payum\\Bundle\\PayumBundle\\Controller\\CaptureController::doAction'], ['payum_token'], null, null, false, true, null]],
        15611 => [[['_route' => 'payum_notify_do_unsafe', '_controller' => 'Payum\\Bundle\\PayumBundle\\Controller\\NotifyController::doUnsafeAction'], ['gateway'], null, null, false, true, null]],
        15629 => [[['_route' => 'payum_notify_do', '_controller' => 'Payum\\Bundle\\PayumBundle\\Controller\\NotifyController::doAction'], ['payum_token'], null, null, false, true, null]],
        15662 => [[['_route' => 'sylius_payment_method_notify', '_controller' => 'sylius.controller.payment_method_notify'], ['code'], null, null, false, true, null]],
        15689 => [[['_route' => 'sylius_payment_request_notify', '_controller' => 'sylius.controller.payment_request_notify'], ['hash'], null, null, false, true, null]],
        15718 => [[['_route' => '_wdt', '_controller' => 'web_profiler.controller.profiler::toolbarAction'], ['token'], null, null, false, true, null]],
        15762 => [[['_route' => '_profiler_font', '_controller' => 'web_profiler.controller.profiler::fontAction'], ['fontName'], null, null, false, false, null]],
        15801 => [[['_route' => '_profiler_search_results', '_controller' => 'web_profiler.controller.profiler::searchResultsAction'], ['token'], null, null, false, false, null]],
        15817 => [[['_route' => '_profiler_router', '_controller' => 'web_profiler.controller.router::panelAction'], ['token'], null, null, false, false, null]],
        15839 => [[['_route' => '_profiler_exception', '_controller' => 'web_profiler.controller.exception_panel::body'], ['token'], null, null, false, false, null]],
        15854 => [[['_route' => '_profiler_exception_css', '_controller' => 'web_profiler.controller.exception_panel::stylesheet'], ['token'], null, null, false, false, null]],
        15866 => [
