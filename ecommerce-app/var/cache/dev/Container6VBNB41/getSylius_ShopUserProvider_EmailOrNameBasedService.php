...
class getSylius_ShopUserProvider_EmailOrNameBasedService extends App_KernelDevDebugContainer
{
    ...
    {
        if (true === $lazyLoad) {
            return $container->privates['sylius.shop_user_provider.email_or_name_based'] = $container->createProxy('UsernameOrEmailProviderGhost37f0eb1', static fn () => \UsernameOrEmailProviderGhost37f0eb1::createLazyGhost(static fn ($proxy) => self::do($container, $proxy)));
        }
        ...
        return ($lazyLoad->__construct('App\\Entity\\User\\ShopUser', ($container->services['sylius.repository.shop_user'] ?? $container->load('getSylius_Repository_ShopUserService')), ($container->privates['sylius.canonicalizer'] ??= new \Sylius\Component\User\Canonicalizer\Canonicalizer())) && false ?: $lazyLoad);
    }
}
