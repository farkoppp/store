...
class getSylius_Listener_CanonicalizerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['sylius.listener.canonicalizer'] = new \Sylius\Bundle\CoreBundle\EventListener\CanonicalizerListener(($container->privates['sylius.canonicalizer'] ??= new \Sylius\Component\User\Canonicalizer\Canonicalizer()));
    }
}
