...
class getRouting_LoaderService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/vendor/sylius/sylius/src/Sylius/Bundle/ApiBundle/ApiPlatform/Routing/ApiLoader.php';
        ...
        $b->addLoader(new \Symfony\Component\Routing\Loader\ContainerLoader(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'sylius.symfony.routing.loader.resource' => ['privates', 'sylius.symfony.routing.loader.resource', 'getSylius_Symfony_Routing_Loader_ResourceService', true],
            ...
            'sylius.symfony.routing.loader.resource' => 'Sylius\\Resource\\Symfony\\Routing\\Loader\\ResourceLoader',
        ...
        $b->addLoader(new \Sylius\Bundle\ApiBundle\ApiPlatform\Routing\ApiLoader(new \ApiPlatform\Symfony\Routing\ApiLoader(($container->services['kernel'] ?? $container->get('kernel', 1)), ($container->privates['api_platform.metadata.resource.name_collection_factory.cached'] ?? self::getApiPlatform_Metadata_Resource_NameCollectionFactory_CachedService($container)), $a, $container, $container->parameters['api_platform.formats'], $container->parameters['api_platform.resource_class_directories'], false, true, true, false), []));
        $b->addLoader($d);
