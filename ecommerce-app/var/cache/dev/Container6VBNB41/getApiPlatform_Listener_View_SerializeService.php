...
class getApiPlatform_Listener_View_SerializeService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $d = new \ApiPlatform\State\Processor\SerializeProcessor(NULL, $a, $b);
        if ($container->has('debug.stopwatch')) {
            $d->setStopwatch(($container->services['debug.stopwatch'] ??= new \Symfony\Component\Stopwatch\Stopwatch(true)));
        }

        return $container->privates['api_platform.listener.view.serialize'] = new \ApiPlatform\Symfony\EventListener\SerializeListener($d, $c);
    }
}
