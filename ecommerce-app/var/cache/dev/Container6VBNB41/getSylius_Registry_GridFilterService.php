...
class getSylius_Registry_GridFilterService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/vendor/sylius/mollie-plugin/src/Grid/Filter/MollieLoggerLevel.php';
        include_once \dirname(__DIR__, 4).'/vendor/sylius/mollie-plugin/src/Grid/Filter/MollieSubscriptionState.php';
        ...
        $instance->register('resource_autocomplete', new \Sylius\Component\Core\Grid\Filter\ResourceAutocompleteFilter());
        ...
        $instance->register('ux_autocomplete', new \Sylius\Component\Grid\Filter\EntityFilter());
        $instance->register('ux_translatable_autocomplete', new \Sylius\Component\Grid\Filter\EntityFilter());
        $instance->register('shop_string', new \Sylius\Component\Grid\Filter\StringFilter());
        $instance->register('log_level', new \Sylius\MolliePlugin\Grid\Filter\MollieLoggerLevel());
        $instance->register('subscription_state', new \Sylius\MolliePlugin\Grid\Filter\MollieSubscriptionState());
