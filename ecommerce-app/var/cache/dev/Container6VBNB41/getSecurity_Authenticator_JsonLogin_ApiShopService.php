 ...
 */
class getSecurity_Authenticator_JsonLogin_ApiShopService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'security.authenticator.json_login.api_shop' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['security.authenticator.json_login.api_shop'])) {
            return $container->privates['security.authenticator.json_login.api_shop'];
        }
        ...
        $container->privates['security.authenticator.json_login.api_shop'] = $instance = new \Symfony\Component\Security\Http\Authenticator\JsonLoginAuthenticator($a, ($container->privates['sylius.shop_user_provider.email_or_name_based'] ?? $container->load('getSylius_ShopUserProvider_EmailOrNameBasedService')), new \Symfony\Component\Security\Http\Authentication\CustomAuthenticationSuccessHandler(new \Lexik\Bundle\JWTAuthenticationBundle\Security\Http\Authentication\AuthenticationSuccessHandler($b, $c, [], true), [], 'api_shop'), new \Symfony\Component\Security\Http\Authentication\CustomAuthenticationFailureHandler(new \Lexik\Bundle\JWTAuthenticationBundle\Security\Http\Authentication\AuthenticationFailureHandler($c, $d), []), ['check_path' => '/api/v2/shop/customers/token', 'username_path' => 'email', 'password_path' => 'password', 'use_forward' => false, 'login_path' => '/login'], ($container->privates['property_accessor'] ?? self::getPropertyAccessorService($container)));
