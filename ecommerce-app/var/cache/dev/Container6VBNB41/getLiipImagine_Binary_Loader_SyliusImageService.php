 ...
 */
class getLiipImagine_Binary_Loader_SyliusImageService extends App_KernelDevDebugContainer
{
    /**
     * Gets the public 'liip_imagine.binary.loader.sylius_image' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['liip_imagine.binary.loader.sylius_image'] = new \Liip\ImagineBundle\Binary\Loader\FileSystemLoader($a, $a, new \Liip\ImagineBundle\Binary\Locator\FileSystemLocator([(\dirname(__DIR__, 4).'/public/media/image')], false));
    }
}
