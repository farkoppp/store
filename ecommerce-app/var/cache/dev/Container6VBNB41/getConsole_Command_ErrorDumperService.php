...
class getConsole_Command_ErrorDumperService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['console.command.error_dumper'] = $instance = new \Symfony\Component\ErrorHandler\Command\ErrorDumpCommand(($container->privates['filesystem'] ??= new \Symfony\Component\Filesystem\Filesystem()), ($container->privates['sylius.twig.error_renderer'] ?? $container->load('getSylius_Twig_ErrorRendererService')), ($container->privates['webpack_encore.entrypoint_lookup[_default]'] ?? $container->load('getWebpackEncore_EntrypointLookupDefaultService')));
