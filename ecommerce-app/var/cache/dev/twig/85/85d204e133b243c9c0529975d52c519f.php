...
/* @SyliusAdmin/product/form/sections/taxes.html.twig */
class __TwigTemplate_1c4e43460d8f97faa793572fb5209838 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "@SyliusAdmin/product/form/sections/taxes.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "@SyliusAdmin/product/form/sections/taxes.html.twig"));
...
";
        ...
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, (isset($context["product"]) || array_key_exists("product", $context) ? $context["product"] : (function () { throw new RuntimeError('Variable "product" does not exist.', 3, $this->source); })()), "isSimple", [], "any", false, false, false, 3)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            ...
            yield "\" id=\"taxes\" role=\"tabpanel\" tabindex=\"0\">
        <div class=\"card mb-3\">
            <div class=\"card-header\">
                <h2 id=\"taxes\" class=\"card-title\">";
            // line 7
...
echo $hooksRuntime->renderHook("taxes", [], $context, false);
            // line 11
            yield "            </div>
        </div>
    </div>
";
    ...
    {
        return "@SyliusAdmin/product/form/sections/taxes.html.twig";
    }
...
{% if product.isSimple %}
    <div class=\"tab-pane {% if hookable_metadata.configuration.active|default(false) %}show active{% endif %}\" id=\"taxes\" role=\"tabpanel\" tabindex=\"0\">
        <div class=\"card mb-3\">
            <div class=\"card-header\">
                <h2 id=\"taxes\" class=\"card-title\">{{ 'sylius.ui.taxes'|trans }}</h2>
            </div>
            <div class=\"card-body\">
                {% hook 'taxes' %}
            </div>
...
{% endif %}
", "@SyliusAdmin/product/form/sections/taxes.html.twig", "/home/farkoppp/Documents/vitalik/ecommerce-app/vendor/sylius/sylius/src/Sylius/Bundle/AdminBundle/templates/product/form/sections/taxes.html.twig");
    }
}
