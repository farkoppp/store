...
class __TwigTemplate_4f88bf1249f9faeddeabb1f0e0df81f4 extends Template
{
...
echo $hooksRuntime->renderHook("sylius_shop.product.show", ["product" => (isset($context["product"]) || array_key_exists("product", $context) ? $context["product"] : (function () { throw new RuntimeError('Variable "product" does not exist.', 6, $this->source); })()), "configuration" => (isset($context["configuration"]) || array_key_exists("configuration", $context) ? $context["configuration"] : (function () { throw new RuntimeError('Variable "configuration" does not exist.', 6, $this->source); })())], $context, false);
...
{% endblock %}
", "@SyliusShop/product/show.html.twig", "/home/farkoppp/Documents/vitalik/ecommerce-app/vendor/sylius/sylius/src/Sylius/Bundle/ShopBundle/templates/product/show.html.twig");
    }
}
