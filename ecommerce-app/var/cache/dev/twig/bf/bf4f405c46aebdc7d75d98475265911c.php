...
class __TwigTemplate_1ccc0482a8987c8fe3d359df139c8091 extends Template
{
...
(isset($context["log"]) || array_key_exists("log", $context) ? $context["log"] : (function () { throw new RuntimeError('Variable "log" does not exist.', 9, $this->source); })()), "action", [], "any", false, false, false, 9) == "update")) {
    ...
    {% endif %}
{%- endmacro -%}
", "@SyliusAdmin/order/history/macro/action_label.html.twig", "/home/farkoppp/Documents/vitalik/ecommerce-app/vendor/sylius/sylius/src/Sylius/Bundle/AdminBundle/templates/order/history/macro/action_label.html.twig");
    }
}
