...
/* @SyliusAdmin/shared/grid/action/show.html.twig */
class __TwigTemplate_eb92f920d177583d79652f048e826342 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "@SyliusAdmin/shared/grid/action/show.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "@SyliusAdmin/shared/grid/action/show.html.twig"));
        ...
        if (CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["options"] ?? null), "link", [], "any", false, true, false, 1), "url", [], "any", true, true, false, 1)) {
            ...
            // line 4
            yield "    ";
            $context["default_route"] = ((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["options"] ?? null), "link", [], "any", false, true, false, 4), "route", [], "any", true, true, false, 4)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["options"]) || array_key_exists("options", $context) ? $context["options"] : (function () { throw new RuntimeError('Variable "options" does not exist.', 4, $this->source); })()), "link", [], "any", false, false, false, 4), "route", [], "any", false, false, false, 4), ((CoreExtension::getAttribute($this->env, $this->source, ($context["grid"] ?? null), "requestConfiguration", [], "any", true, true, false, 4)) ? (CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["grid"]) || array_key_exists("grid", $context) ? $context["grid"] : (function () { throw new RuntimeError('Variable "grid" does not exist.', 4, $this->source); })()), "requestConfiguration", [], "any", false, false, false, 4), "getRouteName", ["show"], "method", false, false, false, 4)) : (null)))) : (((CoreExtension::getAttribute($this->env, $this->source, ($context["grid"] ?? null), "requestConfiguration", [], "any", true, true, false, 4)) ? (CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["grid"]) || array_key_exists("grid", $context) ? $context["grid"] : (function () { throw new RuntimeError('Variable "grid" does not exist.', 4, $this->source); })()), "requestConfiguration", [], "any", false, false, false, 4), "getRouteName", ["show"], "method", false, false, false, 4)) : (null))));
            // line 5
            yield "    ";
...
";
    ...
    {
        return "@SyliusAdmin/shared/grid/action/show.html.twig";
    }
    ...
    {
        return array (  83 => 12,  71 => 11,  68 => 10,  66 => 9,  64 => 8,  61 => 7,  57 => 5,  54 => 4,  50 => 2,  48 => 1,);
    }
...
", "@SyliusAdmin/shared/grid/action/show.html.twig", "/home/farkoppp/Documents/vitalik/ecommerce-app/vendor/sylius/sylius/src/Sylius/Bundle/AdminBundle/templates/shared/grid/action/show.html.twig");
    }
}
