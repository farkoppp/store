...
/* @SyliusAdmin/shared/crud/update/content/header/title_block/title.html.twig */
class __TwigTemplate_b304cce03dd166de772f8ec36fe453d6 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "@SyliusAdmin/shared/crud/update/content/header/title_block/title.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "@SyliusAdmin/shared/crud/update/content/header/title_block/title.html.twig"));
...
<div class=\"col-12 col-md-6\">
    <div class=\"d-md-flex gap-2 align-items-center\">
        ";
        // line 16
        yield $macros["header"]->getTemplateForMacro("macro_h1", $context, 16, $this->getSourceContext())->macro_h1(...[(((($tmp =  !(null === (isset($context["header"]) || array_key_exists("header", $context) ? $context["header"] : (function () { throw new RuntimeError('Variable "header" does not exist.', 16, $this->source); })()))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans((isset($context["header"]) || array_key_exists("header", $context) ? $context["header"] : (function () { throw new RuntimeError('Variable "header" does not exist.', 16, $this->source); })()))) : ((($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("sylius.ui.edit") . " ") . $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans((isset($context["singular_name"]) || array_key_exists("singular_name", $context) ? $context["singular_name"] : (function () { throw new RuntimeError('Variable "singular_name" does not exist.', 16, $this->source); })())))))]);
        yield "
    </div>
</div>
";
    ...
    {
        return "@SyliusAdmin/shared/crud/update/content/header/title_block/title.html.twig";
    }
...
", "@SyliusAdmin/shared/crud/update/content/header/title_block/title.html.twig", "/home/farkoppp/Documents/vitalik/ecommerce-app/vendor/sylius/sylius/src/Sylius/Bundle/AdminBundle/templates/shared/crud/update/content/header/title_block/title.html.twig");
    }
}
