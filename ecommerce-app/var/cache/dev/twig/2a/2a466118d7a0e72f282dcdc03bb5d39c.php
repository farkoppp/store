...
class __TwigTemplate_3e8713cf628ef4ce1d5a7172fc5bca86 extends Template
{
...
(isset($context["data"]) || array_key_exists("data", $context) ? $context["data"] : (function () { throw new RuntimeError('Variable "data" does not exist.', 4, $this->source); })()) == Twig\Extension\CoreExtension::constant("Sylius\\MolliePlugin\\Logger\\LoggerLevel::ERROR"))) {
    ...
    {% endif %}
{% endif %}
", "@SyliusMolliePlugin/admin/logger/grid/field/level.html.twig", "/home/farkoppp/Documents/vitalik/ecommerce-app/vendor/sylius/mollie-plugin/templates/admin/logger/grid/field/level.html.twig");
    }
}
