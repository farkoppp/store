...
/* @SyliusAdmin/order/show/content/sections/items/body/unit_discount.html.twig */
class __TwigTemplate_a6073169aa8fc64f38e2cdf775e4b07a extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "@SyliusAdmin/order/show/content/sections/items/body/unit_discount.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "@SyliusAdmin/order/show/content/sections/items/body/unit_discount.html.twig"));
...
<td class=\"text-end\" ";
        // line 8
        yield $this->env->getFunction('sylius_test_html_attribute')->getCallable()("unit-discount");
        yield ">
    ";
        // line 9
        yield $macros["money"]->getTemplateForMacro("macro_format", $context, 9, $this->getSourceContext())->macro_format(...[CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["item"]) || array_key_exists("item", $context) ? $context["item"] : (function () { throw new RuntimeError('Variable "item" does not exist.', 9, $this->source); })()), "units", [], "any", false, false, false, 9), "first", [], "any", false, false, false, 9), "adjustmentsTotal", [(isset($context["unit_promotion_adjustment"]) || array_key_exists("unit_promotion_adjustment", $context) ? $context["unit_promotion_adjustment"] : (function () { throw new RuntimeError('Variable "unit_promotion_adjustment" does not exist.', 9, $this->source); })())], "method", false, false, false, 9), CoreExtension::getAttribute($this->env, $this->source, (isset($context["order"]) || array_key_exists("order", $context) ? $context["order"] : (function () { throw new RuntimeError('Variable "order" does not exist.', 9, $this->source); })()), "currencyCode", [], "any", false, false, false, 9)]);
        yield "
</td>
";
    ...
    {
        return "@SyliusAdmin/order/show/content/sections/items/body/unit_discount.html.twig";
    }
...
", "@SyliusAdmin/order/show/content/sections/items/body/unit_discount.html.twig", "/home/farkoppp/Documents/vitalik/ecommerce-app/vendor/sylius/sylius/src/Sylius/Bundle/AdminBundle/templates/order/show/content/sections/items/body/unit_discount.html.twig");
    }
}
