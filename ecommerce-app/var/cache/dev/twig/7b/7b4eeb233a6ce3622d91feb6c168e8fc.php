...
/* @SyliusAdmin/product_variant/form/content/update/header/breadcrumbs.html.twig */
class __TwigTemplate_9f472bec12aaa48424444d05e8c91968 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "@SyliusAdmin/product_variant/form/content/update/header/breadcrumbs.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "@SyliusAdmin/product_variant/form/content/update/header/breadcrumbs.html.twig"));
...
(isset($context["product"]) || array_key_exists("product", $context) ? $context["product"] : (function () { throw new RuntimeError('Variable "product" does not exist.', 10, $this->source); })()), "id", [], "any", false, false, false, 10)]), "active" => false], ["name" => ((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source,         // line 11
($context["product_variant"] ?? null), "translations", [], "any", false, true, false, 11), CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 11, $this->source); })()), "locale", [], "any", false, false, false, 11), [], "array", false, true, false, 11), "name", [], "any", true, true, false, 11)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["product_variant"]) || array_key_exists("product_variant", $context) ? $context["product_variant"] : (function () { throw new RuntimeError('Variable "product_variant" does not exist.', 11, $this->source); })()), "translations", [], "any", false, false, false, 11), CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 11, $this->source); })()), "locale", [], "any", false, false, false, 11), [], "array", false, false, false, 11), "name", [], "any", false, false, false, 11), CoreExtension::getAttribute($this->env, $this->source, (isset($context["product_variant"]) || array_key_exists("product_variant", $context) ? $context["product_variant"] : (function () { throw new RuntimeError('Variable "product_variant" does not exist.', 11, $this->source); })()), "code", [], "any", false, false, false, 11))) : (CoreExtension::getAttribute($this->env, $this->source, (isset($context["product_variant"]) || array_key_exists("product_variant", $context) ? $context["product_variant"] : (function () { throw new RuntimeError('Variable "product_variant" does not exist.', 11, $this->source); })()), "code", [], "any", false, false, false, 11))), "active" => true], ["name" => $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("sylius.ui.edit"), "active" => false]]]);
        // line 13
        yield "
";
    ...
    {
        return "@SyliusAdmin/product_variant/form/content/update/header/breadcrumbs.html.twig";
    }
    ...
    {
        return array (  65 => 13,  63 => 11,  62 => 10,  61 => 9,  60 => 6,  57 => 5,  55 => 4,  53 => 3,  50 => 2,  48 => 1,);
    }
...
{{ breadcrumbs([
    ...
    { name: product_variant.translations[app.locale].name|default(product_variant.code), active: true },
    { name: 'sylius.ui.edit'|trans, active: false }
]) }}
", "@SyliusAdmin/product_variant/form/content/update/header/breadcrumbs.html.twig", "/home/farkoppp/Documents/vitalik/ecommerce-app/vendor/sylius/sylius/src/Sylius/Bundle/AdminBundle/templates/product_variant/form/content/update/header/breadcrumbs.html.twig");
    }
}
