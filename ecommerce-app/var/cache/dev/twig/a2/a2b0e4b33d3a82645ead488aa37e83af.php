...
/* @SyliusAdmin/product/show/content/page_body/general/configurable_product/details/pricing.html.twig */
class __TwigTemplate_cb237c0b4e8f2bbe87fb5176d75a4af6 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "@SyliusAdmin/product/show/content/page_body/general/configurable_product/details/pricing.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "@SyliusAdmin/product/show/content/page_body/general/configurable_product/details/pricing.html.twig"));
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["channel_pricing"]) {
            ...
            if ((($tmp = (isset($context["channel"]) || array_key_exists("channel", $context) ? $context["channel"] : (function () { throw new RuntimeError('Variable "channel" does not exist.', 19, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                ...
                yield "
                    <tr ";
                // line 22
                yield $this->env->getFunction('sylius_test_html_attribute')->getCallable()("variant-pricing", Twig\Extension\CoreExtension::sprintf("%s.%s", CoreExtension::getAttribute($this->env, $this->source, (isset($context["channel"]) || array_key_exists("channel", $context) ? $context["channel"] : (function () { throw new RuntimeError('Variable "channel" does not exist.', 22, $this->source); })()), "code", [], "any", false, false, false, 22), CoreExtension::getAttribute($this->env, $this->source, (isset($context["variant"]) || array_key_exists("variant", $context) ? $context["variant"] : (function () { throw new RuntimeError('Variable "variant" does not exist.', 22, $this->source); })()), "code", [], "any", false, false, false, 22)));
                yield " ";
                yield $this->env->getFunction('sylius_test_html_attribute')->getCallable()("pricing", Twig\Extension\CoreExtension::sprintf("%s", CoreExtension::getAttribute($this->env, $this->source, (isset($context["channel"]) || array_key_exists("channel", $context) ? $context["channel"] : (function () { throw new RuntimeError('Variable "channel" does not exist.', 22, $this->source); })()), "code", [], "any", false, false, false, 22)));
                yield " >
                        ";
                // line 23
$hooksRuntime = $this->env->getRuntime('Sylius\TwigHooks\Twig\Runtime\HooksRuntime');
echo $hooksRuntime->renderHook("pricing#body", ["variant" => (isset($context["variant"]) || array_key_exists("variant", $context) ? $context["variant"] : (function () { throw new RuntimeError('Variable "variant" does not exist.', 23, $this->source); })()), "channel" => (isset($context["channel"]) || array_key_exists("channel", $context) ? $context["channel"] : (function () { throw new RuntimeError('Variable "channel" does not exist.', 23, $this->source); })()), "channel_pricing" => $context["channel_pricing"], "currency_code" => (isset($context["currency_code"]) || array_key_exists("currency_code", $context) ? $context["currency_code"] : (function () { throw new RuntimeError('Variable "currency_code" does not exist.', 23, $this->source); })())], $context, false);
                // line 24
                yield "                    </tr>
                    ";
            } else {
                ...
                yield "                        ";
$hooksRuntime = $this->env->getRuntime('Sylius\TwigHooks\Twig\Runtime\HooksRuntime');
echo $hooksRuntime->renderHook("pricing#body", ["variant" => (isset($context["variant"]) || array_key_exists("variant", $context) ? $context["variant"] : (function () { throw new RuntimeError('Variable "variant" does not exist.', 26, $this->source); })()), "channel_pricing" => $context["channel_pricing"]], $context, false);
                // line 27
                yield "                    ";
            }
            // line 28
...
";
    ...
    {
        return "@SyliusAdmin/product/show/content/page_body/general/configurable_product/details/pricing.html.twig";
    }
    ...
    {
        return array (  118 => 29,  112 => 28,  109 => 27,  105 => 26,  101 => 24,  98 => 23,  92 => 22,  89 => 21,  86 => 20,  84 => 19,  81 => 18,  78 => 17,  74 => 16,  69 => 13,  66 => 12,  57 => 6,  52 => 3,  50 => 2,  48 => 1,);
    }
...
", "@SyliusAdmin/product/show/content/page_body/general/configurable_product/details/pricing.html.twig", "/home/farkoppp/Documents/vitalik/ecommerce-app/vendor/sylius/sylius/src/Sylius/Bundle/AdminBundle/templates/product/show/content/page_body/general/configurable_product/details/pricing.html.twig");
    }
}
