...
class __TwigTemplate_9d9a3184a0e15cac0f16d8d627762852 extends Template
{
...
echo $hooksRuntime->renderHook("complete", ["_prefixes" => (isset($context["prefixes"]) || array_key_exists("prefixes", $context) ? $context["prefixes"] : (function () { throw new RuntimeError('Variable "prefixes" does not exist.', 10, $this->source); })()), "order" => (isset($context["order"]) || array_key_exists("order", $context) ? $context["order"] : (function () { throw new RuntimeError('Variable "order" does not exist.', 10, $this->source); })()), "form" => (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 10, $this->source); })()), "active_step" => (isset($context["active_step"]) || array_key_exists("active_step", $context) ? $context["active_step"] : (function () { throw new RuntimeError('Variable "active_step" does not exist.', 10, $this->source); })())], $context, false);
    ...
    {
        return array (  145 => 13,  132 => 10,  119 => 9,  96 => 4,  71 => 3,  60 => 1,  58 => 7,  56 => 6,  43 => 1,);
    }
...
{% block sidebar %}
{% endblock %}
", "@SyliusShop/checkout/complete.html.twig", "/home/farkoppp/Documents/vitalik/ecommerce-app/vendor/sylius/sylius/src/Sylius/Bundle/ShopBundle/templates/checkout/complete.html.twig");
    }
}
