...
class __TwigTemplate_4e96c3b9034e87c96026cd8fa334df69 extends Template
{
...
";
    ...
    public function block_content(array $context, array $blocks = []): iterable
    {
        ...
        <span>";
        // line 9
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("sylius.email.user.account_verification.message", [], null, (isset($context["localeCode"]) || array_key_exists("localeCode", $context) ? $context["localeCode"] : (function () { throw new RuntimeError('Variable "localeCode" does not exist.', 9, $this->source); })())), "html", null, true);
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 9, $this->source); })()), "emailVerificationToken", [], "any", false, false, false, 9), "html", null, true);
        yield "</span>
    </div>
";
    ...
    {
        return array (  107 => 9,  104 => 8,  91 => 7,  77 => 4,  64 => 3,  41 => 1,);
    }
...
{% block content %}
    <div style=\"text-align: center;\">
        <span>{{ 'sylius.email.user.account_verification.message'|trans({}, null, localeCode) }}{{ user.emailVerificationToken }}</span>
    </div>
{% endblock %}
", "@SyliusCore/Email/accountVerification.html.twig", "/home/farkoppp/Documents/vitalik/ecommerce-app/vendor/sylius/sylius/src/Sylius/Bundle/CoreBundle/Resources/views/Email/accountVerification.html.twig");
    }
}
