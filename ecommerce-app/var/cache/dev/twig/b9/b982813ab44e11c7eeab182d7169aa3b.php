...
/* @SyliusAdmin/promotion_coupon/generate/form.html.twig */
class __TwigTemplate_9eb945f08f75c56d26abb37149794ef7 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "@SyliusAdmin/promotion_coupon/generate/form.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "@SyliusAdmin/promotion_coupon/generate/form.html.twig"));
...
<div class=\"container-xl\" ";
    ...
    <div class=\"row\">
        ...
        ";
        // line 7
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 7, $this->source); })()), "_token", [], "any", false, false, false, 7), 'widget');
        yield "
...
echo $hooksRuntime->renderHook("form", ["form" => (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 9, $this->source); })())], $context, false);
    ...
    ";
        // line 11
        yield         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 11, $this->source); })()), 'form_end', ["render_rest" => ((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["hookable"] ?? null), "configuration", [], "any", false, true, false, 11), "render_rest", [], "any", true, true, false, 11)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["hookable"]) || array_key_exists("hookable", $context) ? $context["hookable"] : (function () { throw new RuntimeError('Variable "hookable" does not exist.', 11, $this->source); })()), "configuration", [], "any", false, false, false, 11), "render_rest", [], "any", false, false, false, 11), true)) : (true))]);
        yield "
</div>
";
    ...
    {
        return "@SyliusAdmin/promotion_coupon/generate/form.html.twig";
    }
    ...
    {
        return array (  77 => 11,  74 => 10,  71 => 9,  66 => 7,  62 => 6,  57 => 4,  53 => 3,  50 => 2,  48 => 1,);
    }
...
", "@SyliusAdmin/promotion_coupon/generate/form.html.twig", "/home/farkoppp/Documents/vitalik/ecommerce-app/vendor/sylius/sylius/src/Sylius/Bundle/AdminBundle/templates/promotion_coupon/generate/form.html.twig");
    }
}
